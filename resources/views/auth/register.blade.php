                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register.user') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old
...
old('email') }}" required>
                            ...
                            <div class="form-group row">
                                <label for="accept-conditions" class="col-md-4 col-form-label text-md-right">{{ __('Accept Conditions') }}</label>

                                <div class="col-md-6">
                                    <input id="accept-conditions" type="checkbox" class="form-control" name="accept_conditions" required>
